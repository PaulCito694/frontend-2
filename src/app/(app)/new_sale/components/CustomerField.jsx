  ...
  return (
    <span className="bg-green-300 p-2 mb-4 flex gap-4">
      ...
      <Input
        ...
        label={'id'}
      />
      <Input name="customer.person_attributes.name" label={'Nombre'} />
      <Input name="customer.tax_address" label={'Direccion'} />
      <Input name="customer.person_attributes.email" label={'Email'} />
      <Input name="customer.person_attributes.telephone" label={'Telefono'} />
    </span>
  )
}
